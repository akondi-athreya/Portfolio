...
const greeting = {
  ...
  subTitle:
    "A full-stack developer passionate about building scalable and impactful solutions. I thrive on creating seamless systems and focus on building efficient and user-friendly solutions.",
  resumeLink:
    "https://drive.google.com/file/d/1eNCl9ohs4ddePz1qq8gW34u_m7Ff2dKI/view?usp=sharing",
      ...
      experiences: [
        {
          ...
          location: "",
          description:
            "Developing a full-stack web application for a social service platform using Next.js for the frontend and Node.js for the backend.Implementing user authentication, real-time messaging, notification and amny more. Designing and optimizing the database schema for efficient data storage and retrieval.",
          color: "#000000",
        },
      ],
    },
